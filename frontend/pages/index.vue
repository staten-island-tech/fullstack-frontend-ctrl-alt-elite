  ...
  <div class="bg-black h-full">
    ...
    <section id="welcoming-page"> 
      <div class="flex flex-row items-center h-5/6 mx-12" data-aos="fade-right">
        <div class="m-0 ml-20 2xl:w-1/3 xl:w-1/3 lg:w-1/2 md:w-1/2">
          ...
          <p class="text-white 2xl:text-xl xl:text-lg lg:text-lg md:text-lg sm:text-base my-5">Lorem ipsum dolor sit amet consectetur adipisicing elit. Fuga modi accusamus adipisci rem est perspiciatis odio. Aspernatur tenetur quis recusandae officiis quae quas aperiam quidem eos eveniet. Odit, quisquam ut!</p>
          <SignupButton class="text-white border h-10 2xl:w-1/3 xl:w-1/3 lg:w-1/2 md:w-1/2 sm:w-1/2 ml-0 2xl:text-lg md:text-xs sm:text-xs">Sign up today!</SignupButton>
        </div>  
      </div>
    </section>
