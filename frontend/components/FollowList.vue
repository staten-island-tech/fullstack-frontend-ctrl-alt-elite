  ...
  <div class="flex flex-col justify-center items-center text-black dark:text-white">
     ...
     <template v-else>
      ...
      <div  v-for="item in list.data" :key="item.user_id"   >
          ...
          <div class="py-5 px-5 min-h-40 h-auto md:h-40 max-w-sm mx-auto text-white dark:text-black bg-black dark:bg-white  rounded-xl shadowing space-y-2 sm:py-4 sm:flex sm:items-center   sm:space-y-0 sm:space-x-6 ">
