<template>
  <div class="h-36 w-56 sm:h-40 sm:w-72 md:h-60 md:w-96 bg-gray-300 dark:bg-black rounded border dark:border-slate border-light-gray" :class="{ light : !this.$store.state.darkMode }">
