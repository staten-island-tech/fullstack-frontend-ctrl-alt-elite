<template>
  <div class="h-60 w-96 flex flex-col justify-center bg-l-bg-secondary dark:bg-d-bg-primary rounded border dark:border-slate border-light-gray" :class="{ light : !this.$store.state.darkMode }">
