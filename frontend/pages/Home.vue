            ...
            <div class="xl:mt-12">
              ...
              >
                <h2 class="text-black dark:text-white text-2xl">
                  <Slideshow :project="projects" class="mb-6" />
                </h2>
              </div>
            </div>
          </div>
        ...
        >
          <div
            class="
              xl:fixed
              bg-l-bg-primary
              dark:bg-d-bg-secondary
              h-5/6
              xl:w-1/6 xl:right-16
              2xl:right-20
              xl:top-20
              flex flex-col
              items-center
          ...
          >
            ...
            <div
              ...
              "
              :class="{
                sidebarDark: this.$store.state.darkMode,
                sidebarLight: !this.$store.state.darkMode,
              }"
            >
              <div v-for="(project, key) in recent" :key="key" class="w-3/4">
                <div
                  ...
                  "
                >
                  <h3 class="dark:text-white text-lg 2xl:text-xl">
              ...
              <NuxtLink
                to="/Profile/Projects"
                class="text-black dark:text-light-gray"
                ><p>View all projects...</p></NuxtLink
              >
            </div>
            <button
              class="
                border-t border-mid-gray
                dark:text-white
                text-black
                flex
                items-center
...
export default {
  ...
  async mounted() {
    try {
      ...
      this.$store.commit('updateOtherIDInfo', {
        mongo_id: parsedProfile.data._id,
        email: parsedProfile.data.user_id,
      })
      await DBFunctions.getProjects(
        this.$store.state.otherIDInfo.mongo_id,
        this.recent
      )
      await DBFunctions.getFollowingProjects(
        this.$store.state.otherIDInfo.mongo_id,
        this.followingProjects
      )
